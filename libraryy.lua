...
local library = {
    ...
    signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/dariusplayz1/dopamine/main/signal.lua'))();
    open = false;
    opening = false;
    hasInit = false;
